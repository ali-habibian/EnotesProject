...
<nav class="navbar navbar-expand-lg navbar-dark bg-custom navbar-custom">
    ...
    <div class="collapse navbar-collapse" id="navbarSupportedContent">
        ...
        <a class="btn btn-light my-2 my-sm-0 mr-2" type="submit"><i class="fa fa-user-circle-o"
                                                                    aria-hidden="true"></i> Login</a>
        <a class="btn btn-light my-2 my-sm-0" type="submit"><i class="fa fa-user-plus" aria-hidden="true"></i>
            Register</a>
    </div>
</nav>
